...
{
    public class PlayVisualizer : LineDrawer
    {
        // Singleton
        public static PlayVisualizer Instance;
        ...
        public void ClearGeometry(bool clearAll = true)
        {
            ...
            PlayProgramManager.Instance.SpaceQueryDescription = "";
        ...
        public void Query_PlayspaceAlignment()
        {
            ...
            PlayProgramManager.Instance.SpaceQueryDescription = "Playspace Alignment OBB";
        }
        ...
        public void Query_Topology_FindLargeWall()
        {
            ...
            if (wallCount == 0)
            {
                PlayProgramManager.Instance.SpaceQueryDescription = "Find Largest Wall (0)";
                return;
            }
            ...
            PlayProgramManager.Instance.SpaceQueryDescription = "Find Largest Wall (1)";
        }
        ...
        private void HandleResults_Topology(string visDesc, int locationCount, Vector3 boxFullDims, Color color)
        {
            ...
            {
                PlayProgramManager.Instance.SpaceQueryDescription = string.Format("{0} ({1})", visDesc, locationCount);
            }
            else
            {
                PlayProgramManager.Instance.SpaceQueryDescription = string.Format("{0} (found={1}, displayed={2})", visDesc, locationCount, boxesDisplayed);
            }
        }
        ...
        private void HandleResults_Shape(string visDesc, int shapeCount, Color color, Vector3 defaultHalfDims)
        {
            ...
            {
                PlayProgramManager.Instance.SpaceQueryDescription = string.Format("{0} ({1})", visDesc, shapeCount);
            }
            else
            {
                PlayProgramManager.Instance.SpaceQueryDescription = string.Format("{0} (found={1}, displayed={2})", visDesc, shapeCount, boxesDisplayed);
            }
        }
